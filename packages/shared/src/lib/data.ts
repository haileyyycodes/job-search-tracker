...
const rawCompanies: RawCompany[] = [
  {
    ...
    website: "https://haileyyycodes.github.io/",
...
const rawContacts: RawContact[] = [
  ...
  },
  {
    id: "c6",
    name: "Morgan Reyes",
    linkedInUrl: "https://haileyyycodes.github.io/",
    role: "Former manager",
...
const rawApplications: RawApplication[] = [
  {
    ...
    link: "https://haileyyycodes.github.io/",
    referral: true,
...
export const resumeTypeLabels: Record<ResumeType, string> = {
  untailored: "Untailored",
  tailored: "Tailored resume",
};

export const resumeTypeOptions: { value: ResumeType; label: string }[] = [
...
export const applicationSourceOptions: { value: ApplicationSource; label: string }[] = [
